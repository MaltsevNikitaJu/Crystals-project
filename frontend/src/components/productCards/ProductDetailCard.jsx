...
import { Dialog, DialogContent, DialogTitle, Typography, Box, Button, IconButton, Table, TableBody, TableRow, TableCell } from '@mui/material';
          ...
          <Box sx={{ flex: 2 }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mt: 2 }}>
              ...
              <Button 
                ...
                sx={{ ml: 'auto', backgroundColor: 'rgba(238, 217, 206, 0.8)' ,color:'black' }}
